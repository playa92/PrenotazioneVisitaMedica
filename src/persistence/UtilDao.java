	...
	public void createDatabase() throws PersistenceException {
		...
		try {
			String delete = "create SEQUENCE id;"
					...
					+ "create table segnalazione(id BIGINT primary key, nome_utente VARCHAR(255), cognome_utente VARCHAR(255), "
					+ "motivazione VARCHAR(255), commento VARCHAR(255), risposta VARCHAR(255), risolto BOOLEAN);";
